...
//   const redirect_uri = location.state?.from || "/packages";
  ...
  return (
    <div className="container ">
      {/* <h1 className="text-center mt-3"> UpDate Packages Here</h1> */}
      <form
        className=" addService-container  mb-5 pb-5"
        onSubmit={handleSubmit(onSubmit)}
      >
        <h2 className="text-center text-warning fw-bold fs-1 mb-2 mt-2">
          UPDATE TOURS & PACKAGES
        </h2>
        <Row className="mb-3">
          <Col>
            <h5>Location *</h5>
        ...
        <Row className="mt-4">
          <Col>
            ...
            <select className="  w-100 h-50" {...register("day")}>
              <option value="Available on all days">
